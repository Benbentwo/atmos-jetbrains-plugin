...
/**
 * Action to run 'atmos validate component' for the current context.
 */
class ValidateComponentAction : AtmosBaseAction(
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val settings = runManager.createConfiguration("Validate $component", configType.configurationFactories[0])
        val config = settings.configuration as AtmosRunConfiguration
        config.commandType = AtmosCommandType.VALIDATE_COMPONENT
